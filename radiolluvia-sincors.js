...
(function(d, D) {
    ...
    d.fn.radiolluvia = function(m) {
        ...
        w ? this.each(function() {
            var G = d(this).data("radiolluvia"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("radiolluvia", new d.radiolluvia(this,
                m))
        });
        return K
    };
    d.radiolluvia = function(m, w) {
        function t(b, a) {
        ...
        function P() {
            ...
            b = "ie" == ka.browser.name.toLowerCase() && 12 > parseInt(ka.browser.version) ? !0 : !0;
